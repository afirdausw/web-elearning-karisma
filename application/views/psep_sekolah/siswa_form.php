                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <input type="text" name="nisn" id="nisn" class="form-control" placeholder="NISN" value="<?php echo set_value('nisn', (isset($data_siswa->NISN) ? $data_siswa->NISN : ''));?>" required="required">
                        <?php echo form_error('nisn', '<div class="text-danger">', '</div>'); ?>
                      </div>
                      <div class="form-group">
                        <label>NIS<span class="text-danger">*</span></label>
                        <input type="text" name="nis" id="nis" class="form-control" placeholder="NIS" value="<?php echo set_value('nis', (isset($data_siswa->NIS) ? $data_siswa->NIS : ''));?>" required="required">
                    ...
                    <div class="col-md-offset-1 col-md-5">
                      ...
                      <div class="form-group">
                        ...
                        <select data-placeholder="Pilih Sekolah..." id="sekolah" name="sekolah" class="chosen-select" onchange="fetch_select_kelas(this.value)" style="width: 100% !important;" tab-index="6">
                          <option value=""></option>
                          <?php 
...
<script type="text/javascript">
  function fetch_select_sekolah(val)
  {
    $.ajax({
      type: 'POST',
      url: "<?=base_url('psep_sekolah/siswa/ajax_select_sekolah')?>",
      data: { id:val },
  ...
  function fetch_select_kelas(val)
  {
    ...
    $.ajax({
      type: 'POST',
      url: "<?=base_url('psep_sekolah/siswa/ajax_select_kelas')?>",
      data: { id:val },
      success: function(response){
