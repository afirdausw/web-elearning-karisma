            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Report Analisis Siswa</h4>
                                <p class="category">Report Analisis Siswa</p>
                            </div>
                            <div class="content">
                                <div class="row">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <td>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select id="tryout" placeholder="Pilih Profil Try Out " name="tryout" class="chosen-select form-control"  style="width: 100%;" tabindex="1" required="required" >
                                                        <option value="" disabled selected>-- Pilih Profil Try Out --</option>
                                                        <?php
