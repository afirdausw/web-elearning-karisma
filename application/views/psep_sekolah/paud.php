            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <a href="<?php echo site_url('psep_sekolah/paud/manajemen/tambah') ?>"  class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Konten</a>
                                <a href="<?php echo site_url('psep_sekolah/paud/manajemen/seri') ?>" style="margin-right: 10px" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Seri Judul</a>
...
<script type="text/javascript">
    ...
    {
        $.post("<?=base_url('psep_sekolah/materi/ajax_status_materi');?>",
            {
