      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                <a href="<?php echo site_url('psep_sekolah/mapel/manajemen/tambah/'.$kelas) ?>"
                   class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Mapel</a>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="button-group">
                                <a href="<?php echo base_url('psep_sekolah/materi_pokok/mapel/'.$kelas.'/' . $item->id_mapel) ?>"
                                   class="btn btn-primary btn-xs" title="Materi Pokok"><i
                                            class="glyphicon glyphicon-arrow-right"></i></a>
                                <a href="<?php echo $form_action . 'manajemen/ubah/'.$kelas.'?id=' . $item->id_mapel ?>" class="btn btn-warning btn-xs" title="Ubah"><i class="glyphicon glyphicon-pencil"></i></a>
