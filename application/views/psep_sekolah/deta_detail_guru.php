                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            foreach($dataguru as $guru){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo anchor('psep_sekolah/guru/detail/'.$guru->id_login_sekolah,'Identitas');?></td>
                                                    <td>
                                                        <?php
                                                        if($guru->status == 0){
                                                            echo "Menunggu Verifikasi dari LPIH";
                                                    ...
                                                    <td><?php echo anchor('psep_sekolah/guru/edit/'.$guru->id_login_sekolah,'Edit');?></td>
                                                </tr>
                                                <?php
                                                $no++;
                                            }
