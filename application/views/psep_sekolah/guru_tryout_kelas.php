                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <div class="col-md-6 col-lg-6">
                                    <a href="<?php echo base_url('psep_sekolah/tryout_guru/manajemen/tambahprofil') ?>" class="btn btn-primary">Tambah Profil Try Out</a>
                                </div>
                                            ...
                                            <td class="text-center">
                                                <div class="button-group">
                                                    ...
                                                    if($this->session->userdata('level') == "superadmin" or $this->session->userdata('level') == "admin"){
                                                        ?>
                                                        <a href="#" class="btn btn-danger btn-xs" title="Ubah"><i class="glyphicon glyphicon-remove"></i></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                                        ...
                                        foreach($table_kategori as $kategori){
                                            if($kategori->id_profil == $item->id_tryout){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('psep_sekolah/tryout/manajemen/managesoal/'.$kategori->id_kategori); ?>" class="btn btn-danger"><span class="glyphicon glyphicon-cog"></span> Manage Soal</a></td>
                                                    <td class="text-center">
