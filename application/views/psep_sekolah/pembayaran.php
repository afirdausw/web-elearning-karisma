            ...
            <div class="card">
              <div class="header">
                ...
                <p class="category">Daftar transaksi siswa</p>
								<a class="btn btn-default pull-right" href="<?php echo base_url('psep_sekolah/pembayaran/beli_paket'); ?>" style="margin-top:-45px;"><i class="glyphicon glyphicon-plus"></i> Tambah Pembelian</a>
              </div>
              <div class="content">
              ...
              <?php
                            ...
                            ?>
                              ...
                              <button type="button" class="btn btn-success btn-fill" title="Terima Pembayaran" data-number="<?php echo $no?>" value="<?php echo $item->id_pembelian ?>" data-toggle="modal" data-target="#insert_email_modal"><i class="glyphicon glyphicon-ok"></i></button>
															<?php	} else { ?>
															<a type="button" class="btn btn-success btn-fill" title="Terima Pembayaran" href='<?php echo base_url()."psep_sekolah/pembayaran/terima/".$item->id_pembelian; ?>'><i class="glyphicon glyphicon-ok"></i></a>
														<?php
															}
                            } else {
                              echo "-";
