...
<script>
	$(function(){
		$("#kelas").change(function(){
			$("#listsiswa").load("analisis/ajax_siswa_by_jenjang/" + $("#kelas").val());
		});
	});
</script>
<div class="wrapper">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="header">
								<h4 class="title">Report Try Out Siswa</h4>
								<p class="category">Report analisis Try Out siswa</p>
							</div>
							<div class="content">
								<div class="row">
									<div class="col-lg-offset-3 col-md-offset-3 col-lg-6 col-md-6 col-xs-12 col-sm-12">
										...
										<table id="my_datatable" class="table table-bordered table-striped">
											<thead>
											<tr>
												<td>No. </td>
												<td>Nama Siswa</td>
