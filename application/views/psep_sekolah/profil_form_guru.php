                                            ...
                                            <div class="col-md-4 col-lg-4">
                                                ...
                                                <select data-placeholder="Pilih Kelas..." name="kelas" class="form-control" style="width: 100%;" tabindex="2" required="required">
                                                    ...
                                                    foreach ($carisekolah as $item) { ?>
                                                        ...
                                                        <option <?php echo set_select('kelas', $item->kelas_id, (!isset($data->kelas_id) ? FALSE : ($data->kelas == $item->kelas_id ? TRUE : FALSE)) );?>

                                                            value="<?php echo $item->kelas_id ?>" > <?php echo $item->alias_kelas ?>
