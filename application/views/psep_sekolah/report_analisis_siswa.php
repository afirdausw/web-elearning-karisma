								...
								<div class="row">
									<div class="col-md-12">
										<select id='profile-select' class="form-control"
												onchange="document.location='<?php echo base_url("psep_sekolah/analisis/tryoutsiswa/" . $infosiswa->id_siswa); ?>/'+this.value">
																			...
																			if (count($kategori['daftar_kategori']) > 0) {
																				foreach ($kategori['daftar_kategori'] as $dk) {
																					...
																					<tr>
																						...
																						<td><?php echo $dk['jumlah_soal']; ?></td>
																						<td>
																						<?php if(isset($dk['analisawaktu'][0]['disediakan'])){
																							echo $dk['analisawaktu'][0]['disediakan'];
																						} else {
																							echo "Belum ada data";
																						} ?>																							
																						</td>
																						<td>
																						<?php if(isset($dk['analisawaktu'][0]['dikerjakan'])){
																							echo $dk['analisawaktu'][0]['dikerjakan'];
																						} else {
																							echo "Belum ada data";
																						} ?>
																						</td>
																						<td>
																						<?php if(isset($dk['analisawaktu'][0]['rata_rata'])){
																							echo $dk['analisawaktu'][0]['rata_rata'];
																						} else {
																							echo "Belum ada data";
																						} ?>
																						</td>
