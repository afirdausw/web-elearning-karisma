            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <a href="<?php echo site_url('psep_sekolah/kelas/manajemen/tambah') ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="button-group">
                                                        <a href="<?php echo 'mapel/kelas/' . $item->id_kelas ?>"
                                                           class="btn btn-primary btn-xs" title="Mata Pelajaran"><i
                                                                    class="glyphicon glyphicon-arrow-right"></i></a>
                                                        <a href="<?php echo $form_action . 'manajemen/ubah?id=' . $item->id_kelas ?>"
