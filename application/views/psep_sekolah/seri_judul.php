            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <a href="<?php echo site_url('psep_sekolah/paud/manajemen/tambah_seri') ?>" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Materi Pokok</a>
                            ...
                            <div class="content">
                                <div class="table-responsive">
                                    <table id="my_datatable" class="table table-striped table-hover">
                                        ...
                                        <?php
                                        $no = 1;
                                        foreach ($select_options_seri as $seri)
                                        {
                                            ?>
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $seri->nama?></td>

                                                <td class="text-center">
                                                    <div class="button-group">
                                                        <a href="<?php echo $form_action . 'manajemen/ubah?id=' . $seri->id_seri_video ?>" class="btn btn-warning btn-xs" title="Ubah"><i class="glyphicon glyphicon-pencil"></i></a>
