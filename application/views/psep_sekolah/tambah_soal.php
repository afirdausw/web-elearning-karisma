...
<script>
    $(function () {
        $("#kelas").change(function () {
            document.location = '<?php echo base_url('psep_sekolah/ambil_bank_soal/filter') ?>/' + $(this).val()+'/';
            $("#mapel").load("ambil_bank_soal/ajax_mapel/" + $(this).val());
...
// 		$("#list-soal").load("banksoal/ajax_soal/" + $("#kelas").val() + "/" + $("#mapel").val());
            document.location = '<?php echo base_url('psep_sekolah/ambil_bank_soal/filter') ?>/' + $("#kelas").val()+'/' + $(this).val()+'/';

        });
        $("#topik").change(function () {
            document.location = '<?php echo base_url('psep_sekolah/ambil_bank_soal/filter') ?>/' + $("#kelas").val()+'/'+ $("#mapel").val()+'/' + $(this).val()+'/';
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <a class="btn btn-primary" href="ambil_bank_soal/tambah">Tambah Bank Soal</a>
                                <a class="btn btn-primary" href="ambil_bank_soal/duplikat">Duplikat Bank Soal</a>
