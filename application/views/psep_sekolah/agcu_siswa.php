					...
					<table class="table table-bordered table-striped">
						...
						?>
							<tr>
								...
								<?php
								//<td>ID Siswa: $idsiswa</td>
								//<td>ID Diagnostic siswa trsbt: $diagnostic->id_diagnostic;</td>
								//<td>Data rank : json_encode($rank);</td>
								//<td>Data kategori : json_encode($kategori);</td>?>
							</tr>
						<?php
							}
						?>
