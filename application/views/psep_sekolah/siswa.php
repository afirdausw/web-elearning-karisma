      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                <a href="<?php echo site_url('psep_sekolah/siswa/manajemen/tambah') ?>" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Siswa</a>
                <h4 class="title">Semua Siswa</h4>
                <p class="category">Daftar siswa</p>
                <?=$this->session->userdata('jenjang_psep');?>
