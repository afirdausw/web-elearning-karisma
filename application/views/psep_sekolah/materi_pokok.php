          ...
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                ...
                <a href="<?php echo site_url('psep_sekolah/materi_pokok/manajemen/tambah/'.$kelas.'/'.$mapel) ?>" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Materi Pokok</a>
                ...
                <div class="content">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="button-group">
                                            ...
                                            <a href="<?php echo base_url('psep_sekolah/materi/listdata/'.$kelas.'/'.$mapel.'/'.$item->id_materi_pokok) ?>"
                                               class="btn btn-primary btn-xs" title="Materi Pokok"><i
                                                        class="glyphicon glyphicon-arrow-right"></i></a>
                                            <?php
                                            if($this->session->userdata('level') == "superadmin" or $this->session->userdata('level') == "sekolah"){
                                                ?>
                  ...
                  <a href="<?php echo site_url('psep_sekolah/materi_pokok/manajemen/tambah_by_mapel') ?>" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Materi Pokok</a>
                      ...
                      <table id="my_datatable" class="table table-striped table-hover">
                          ...
                          foreach ($table_data as $item)
                          {
                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                      <div class="button-group">
                                          <a href="<?php echo $form_action . 'manajemen/ubah_materi?id=' . $item->id_materi_pokok ?>" class="btn btn-warning btn-xs" title="Ubah"><i class="glyphicon glyphicon-pencil"></i></a>
