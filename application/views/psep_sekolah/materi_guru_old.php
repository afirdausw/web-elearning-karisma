            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <a href="<?php echo site_url('psep_sekolah/materi_guru/manajemen/tambah') ?>" class="btn btn-success btn-fill pull-right"><i class="fa fa-plus"></i>Tambah Konten</a>
                            ...
                            <div class="content">
                                <div id="containerajax">
                                    ...
                                    <?php include "materi_guru_ajaxpage.php"; ?>
...
<script type="text/javascript">
    ...
    {
        $.post("<?=base_url('psep_sekolah/materi_guru/ajax_status_materi');?>",
            {
