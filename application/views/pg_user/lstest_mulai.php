...
<head>
    ...
    <title>Learning Style Test | Lembaga Pendidikan Islam Hidayatullah</title>
                        ...
                        <div id="item_soal_<?php echo $no; ?>" class="tab-pane fade">
                            ...
                            <div class="row equal-row item-soal">
                                ...
                                <div class="col-sm-6 equal-col jawaban">
                                    ...
                                    if ($item->jawab_c !== "") {
                                        ?>
                                        <input type="radio" class="pilihan_jawaban"
                                               name="pilihan_jawaban<?php echo $no; ?>" id="opt-c_<?php echo $no; ?>"
