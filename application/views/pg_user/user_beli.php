        ...
        <div class="pay-list">
          ...
          <hr>
			<div class="col-sm-12">
				...
				<button type="submit" name="pembayaran_submit" value="submit" class="btn btn-turquoise btn-bayar">Konfirmasi Pembelian <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></button>
			</div>
			<div class="col-lg-12">
				<br>&nbsp;
			</div>
