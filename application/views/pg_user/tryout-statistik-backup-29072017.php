                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <select id='mySelect' class="form-control">
                                <option value='0'>Try Out 1 Kelas 12</option>
                                <option value='1'>Try Out 2 Kelas 12</option>
                                <option value='2'>Try Out 3 Kelas 12</option>
                                <option value='3'>Try Out 4 Kelas 12</option>
                            </select>
                        </div>
                        <ul class="nav nav-tabs" id="myTab" style="display:none;">
                            <li class="active"><a href="#tr_1">Try Out 1 Kelas 12</a></li>
                            <li><a href="#tr_2">Try Out 2 Kelas 12</a></li>
                            <li><a href="#tr_3">Try Out 3 Kelas 12</a></li>
                            <li><a href="#tr_4">Try Out 4 Kelas 12</a></li>
                        </ul>

                        <h6 class="lbl-act-progress text-center">Aktifitas Progress</h6>

                        <div class="tab-content">
                            <div class="tab-pane active" id="tr_1">
                                <div id="chart-container-1"></div>
                            </div> <!-- tryout-1 -->
                            <div class="tab-pane" id="tr_2">
                                <div id="chart-container-2"></div>
                            </div> <!-- tryout-2 -->
                            <div class="tab-pane" id="tr_3">
                                <div id="chart-container-3"></div>
                            </div> <!-- tryout-3 -->
                            <div class="tab-pane" id="tr_4">
                        ...
                        <ul class="list-unstyled list-materi">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tr_2">
                                    <li><span class="glyphicon glyphicon-chevron-right"></span><span>Bahasa Indonesia</span>
                                        <div class="progress progress-materi">
                                    ...
                                    <li><span class="glyphicon glyphicon-chevron-right"></span><span>Fisika</span>
                                        <div class="progress progress-materi">
                                            <div role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 10%;" class="progress-bar"><span class="sr-only">10% Complete</span></div>
                                        </div>
                                    </li>
                                    <li><span class="glyphicon glyphicon-chevron-right"></span><span>Bahasa Inggris</span>
                                        <div class="progress progress-materi">
                                            <div role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 10%;" class="progress-bar"><span class="sr-only">10% Complete</span></div>
                                        </div>
                                    </li>
                                ...
                                <div class="tab-pane" id="tr_3">
                                    <li><span class="glyphicon glyphicon-chevron-right"></span><span>Campuran</span>
                                        <div class="progress progress-materi">
                                            <div role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;" class="progress-bar"><span class="sr-only">20% Complete</span></div>
                                        </div>
                                    </li>
                                ...
                                <div class="tab-pane" id="tr_4">
                                    <li><span class="glyphicon glyphicon-chevron-right"></span><span>Bahasa Indonesia</span>
                                        <div class="progress progress-materi">
                                            <div role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;" class="progress-bar"><span class="sr-only">100% Complete</span></div>
                                        </div>
                                    </li>
                                </div> <!-- tryout-4 -->
                            </div>
