...
<html lang="en">
	...
	<head>
		...
		<title>Try Out <?php echo $infotryout->nama_kategori; ?> | Lembaga Pendidikan Islam Hidayatullah</title>
									...
									<div class="row equal-row item-soal">
										...
										<div class="col-sm-6 equal-col soal">
											<div class="keterangan-wrapper">
												...
												<ul class="keterangan">
													<li>Soal <span id="soal_number">1</span> dari <b><?php echo $jml_soal?></b></li>
...
if($elapsed_time !== ""){
	$waktu = ($durasi->durasi) - round($elapsed_time->elapsed_time);
	$timer = $waktu * 60000;
}else{
	$waktu = $durasi->durasi;
	$timer = $waktu * 60000;
...
<div class="modal fade" id="myModal<?php echo $no;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<div class="modal-content">
		...
		<video class="img-responsive" id="video2" x-webkit-airplay="allow" controls alt="Example File" src="<?php if($item->pembahasan_video!=null){echo base_url('assets/uploads/'.$item->pembahasan_video);}?>"></video>
		</div>
