			...
			<div class="content-rightbar">
				<div id="listbar" class="subs-konten desc-content">
					...
					<div class="sub-scroll">
						...
						<?php if ($next) { ?>
							<a href="<?php echo base_url('materi/tabel_konten_detail/' . $next->id_materi_pokok) ?>"
							   class="btn btn-default next-konten">
			...
			if (($data->status_materi == 0) OR ($allow_akses == TRUE)) { ?>
				<div class="embed-responsive embed-responsive-16by9">
					<iframe width="560" height="315"
							src="https://www.youtube.com/embed/<?php echo $data->video_materi ?>?rel=0&amp;showinfo=0"
							frameborder="0" allowfullscreen></iframe>
				</div>
				<?php
			} else { ?>
				<div id="isi_materi" class="text-center">
					<img src="<?php echo base_url('assets/pg_user/images/icon/paid-notif.png'); ?>" width="468" height="216"
						 alt="Notifikasi Pembayaran" class="img-responsive">
					<br>
					<p>
						Maaf... Konten ini khusus untuk premium member. Silahkan memilih paket dengan harga mulai Rp
						124.000,-
						<br>
