...
<html lang="en">
<head>
    <title>Lembaga Pendidikan Islam HIDAYATULLAH - Belajar Online</title>
        ...
        <div class="hero">
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>Bingung mencari materi pelajaran dan soal buat ujian nasional dan persiapan sbmptn? Jangan
                        khawatir, karena Prime Mobile menyediakan semua bahan materi yang kamu butuhkan.</p>
                    <?php if (!isset($_SESSION['id_siswa'])) { ?>
                        ...
                        <form action="<?php echo base_url('home/do_login'); ?>" method="post" class="form-start"
                              id="login-start" style="display:none;">
                            <div class="col-sm-6">
        ...
        <h2 class="section-title">Mengapa Belajar Online di Prime Mobile?</h1>
            <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    ...
                    <p>Belajar online kapan saja dan dimana saja. Baik dari komputer, laptop, tablet maupun handphone
                        kamu.</p>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    ...
                    <p>Mulai dari materi SD hingga SBMPTN. Mulai dari fisika, matematika, bahasa, biologi, dan
                        sebagainya.</p>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    ...
                    <p>Ingin menguji kemampuanmu? Ikuti latihan dan kuis disetiap materi. Lengkap beserta video
            ...
            <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    ...
                    <p>Belajar mandiri secara online akan meningkatkan fokus dan pemahaman akan materi tanpa
                        gangguan.</p>
                </div>
            </div>
    </div>
...
<section class="section video">
    ...
    <div class="container">
        ...
        if (!empty($video_demo)) {
            foreach ($video_demo as $video) {
                ...
                <div class="col-sm-6 col-md-3 video-container">
                    <a href="#" class="modal-demo-video" id="demo-<?php echo $video->id_sub_materi ?>"
                       data-toggle="modal" data-target="#videoDemoModal"
                       data-source="<?php echo $video->video_materi; ?>">
                        <img src="<?php echo base_url('assets/pg_user/images/video-thumbs/Kelas6SD-Bahasa Indonesia-MemahamiTeks.jpg'); ?>"
                             width="285" height="212" class="img-responsive">
                    </a>
        ...
        for ($i = $num_video; $i < 4; $i++) {
            ?>
            <div class="col-sm-6 col-md-3 video-container">
                <img src="<?php echo base_url('assets/img/no-video.jpg'); ?>" width="285" height="212"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p><a id="pause-button" href="#">Pause</a>
            </div>
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/CopycK8QQ9A?enablejsapi=1&html5=1" frameborder="0"
                            allowfullscreen class="embed-responsive-item" id="video"></iframe>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/9afVdiPno2U?enablejsapi=1&html5=1" frameborder="0"
                            allowfullscreen class="embed-responsive-item" id="video2"></iframe>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" id="stop" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/OBU6XnkHn8Y?enablejsapi=1&html5=1" frameborder="0"
                            allowfullscreen class="embed-responsive-item" id="video3"></iframe>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" id="stop" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/SXKxKoEphvM?enablejsapi=1&html5=1" frameborder="0"
                            allowfullscreen class="embed-responsive-item" id="video4"></iframe>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" id="stop" data-dismiss="modal">Close</button>
    ...
    <div class="container">
        ...
        <div class="col-md-4 testimonial">
            <div class="foto-profil img-circle">
                <img src="<?php echo base_url('assets/pg_user/images/foto-siswa/irfan.jpg') ?>" width="65" height="65"
                     alt="Foto Profil Siswa LPIH" class="img-responsive">
            </div>
            <h4>Muhammad Irfan</h4>
            <h4 class="sub">SMKN 5 Blitar</h4>
            <p>Alhamdulillah. Setelah mengikuti materi online di Prime Mobile, saya berhasil lulus ujian nasional 2015
                dengan nilai memuaskan.</p>
        </div>
        <div class="col-md-4 testimonial">
            <div class="foto-profil img-circle">
                <img src="<?php echo base_url('assets/pg_user/images/foto-siswa/yunita.png') ?>" width="400"
                     height="599" alt="Foto Profil Siswa LPIH" class="img-responsive">
            </div>
            <h4>Yunita Rachma</h4>
            <h4 class="sub">SMA Islam Lampung</h4>
            <p>Materi dan Simulasi soal SBMPTN yang saya pelajari di Prime Mobile sangat membantu saya lulus ujian masuk
                di fakultas kedokteran ITB. Thanks!</p>
        </div>
        <div class="col-md-4 testimonial">
            <div class="foto-profil img-circle">
                <img src="<?php echo base_url('assets/pg_user/images/foto-siswa/ilham.jpg') ?>" width="375" height="500"
                     alt="Foto Profil Siswa LPIH" class="img-responsive">
            </div>
            <h4>Ilham Komarudin</h4>
            <h4 class="sub">Institut Teknologi Surabaya</h4>
            <p>Kursus online dengan materi dan tampilan terbaik yang pernah saya ikuti selama ini. Maju terus Prime
                Mobile, cerdaskan anak bangsa.</p>
        </div>
    </div>
</section>
