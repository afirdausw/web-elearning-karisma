			...
			<div class="container">
				...
				<div class="col-md-4 testimonial">
					<div class="foto-profil img-circle">
						<img src="<?php echo base_url('assets/pg_user/images/foto-siswa/irfan.jpg')?>" width="65" height="65" alt="Foto Profil Siswa LPIH" class="img-responsive">
					</div>
				...
				<div class="col-md-4 testimonial">
					<div class="foto-profil img-circle">
						<img src="<?php echo base_url('assets/pg_user/images/foto-siswa/yunita.png')?>" width="400" height="599" alt="Foto Profil Siswa LPIH" class="img-responsive">
					</div>    
					<h4>Yunita Rachma</h4>
				...
				<div class="col-md-4 testimonial">
					<div class="foto-profil img-circle">    
						<img src="<?php echo base_url('assets/pg_user/images/foto-siswa/ilham.jpg')?>" width="375" height="500" alt="Foto Profil Siswa LPIH" class="img-responsive">
					</div>
