    ...
    <div class="tableofcontent">
                ...
                <?php foreach ($analisis_mapel as $statmapel) {
                    ...
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                             aria-valuemax="100" style="width: <?php echo round($statmapel->skor, 1) . "%"; ?>;">
        ...
        <div class="table-desc">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h4><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Total
                    Peserta: <?php echo $totalpeserta; ?></h4>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h4><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Total
                    Soal: <?php echo $totalsoal->jumlah_soal; ?></h4>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h4><span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                    Benar: <?php echo $jumlahbenar->jumlah_benar; ?> Salah / Belum
                    terjawab: <?php echo $totalsoal->jumlah_soal - $jumlahbenar->jumlah_benar; ?></h4>
            </div>
            <p>&nbsp;
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="text-align: center; background-color: #dff0d8;">
                <span class="glyphicon glyphicon-queen" aria-hidden="true"
                      style="font-size: 40px; margin-top: 15px; color: #59c9ff;"></span>
                <h4>Tertinggi</h4>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                          data-toggle="tab">Hasil Tes</a></li>
                <li role="presentation"><a href="#profile" aria-controls="profile" role="tab"
                                           data-toggle="tab">Rangking</a></li>
                ...
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="overflow: auto;">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 text-center"
                                 style="background-color: #E3E3E3; padding-top: 25px; padding-bottom: 25px; color: #DB5C5C;">
                    ...
                    <div class="collapse" id="collapseExample">
                        <?php foreach ($kategori as $kategoritopik) {
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4><?php echo $kategoritopik->nama_kategori; ?>
                                        / <?php echo $kategoritopik->alias_kelas; ?></h4>
                                </div>
                                <div class="panel-body" style="overflow: auto;">
                                    <table class="table table-stripped table-hover">
                                        <thead>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($topik->status == 1) {
                                                            ...
                                                            <span class="glyphicon glyphicon-thumbs-up"
                                                                  aria-hidden="true" style="color: green;"></span>
                                                            <?php
                                                        } else {
                                                            ?>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        foreach ($dataperingkat as $peringkat) {
                            ...
                            <tr>
                                ...
                                <td><?php echo round(($peringkat->jumlah_benar / $totalsoal->jumlah_soal) * 100, 2); ?>
                                    %
                                </td>
                            </tr>
                            <?php
