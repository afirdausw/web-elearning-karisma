	...
	<div class="container-fluid akun-container">
        ...
        <div class="pay-method">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <br><br>
              <button type="submit" name="pembayaran_submit" value="submit" class="btn btn-turquoise btn-bayar">Beli Paket <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></button>
            </div>
			-->
          </div>
