...
<div class="hasil-wrapper">
                ...
                <li>
                    ...
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                             aria-valuemax="100"
                             style="width: <?php echo round(($statmapel->jumlah_bobot_benar / $statmapel->jumlah_bobot) * 100) . "%"; ?>;">
                        </div>
                    </div>
                </li>
                <?php
    ...
    <div class="hasil-right">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <h5><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Total
                Peserta: <?php echo count($dataperingkat); ?></h5>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <h5><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Total
                Soal: <?php echo $totalsoal->jumlah_soal; ?></h5>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <h5><span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                Benar: <?php echo $jumlahbenar->jumlah_benar; ?></h5>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <h5><span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                Peringkat: <?php echo $peringkatsaya; ?></h5>
        </div>
        <div class="col=lg-12">
            &nbsp;
        </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Hasil
                    Tes</a></li>
            <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Rangking</a>
            </li>
            <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Grafik</a>
            </li>
            <li role="presentation"><a href="#rekap" aria-controls="messages" role="tab" data-toggle="tab">Rekap</a>
            </li>
        </ul>
        ...
        <div class="tab-content" style="overflow-x: scroll;">
            <div role="tabpanel" class="tab-pane active" id="home">
                <div class="hasil-container">
                    <div class="tabel-analisa">
                        <div class="title"><img src="<?php echo base_url('assets/dashboard/images/file.png'); ?>">ANALISIS
                            PELAJARAN
                        </div>
                        <table class="table">
                            <thead>
                    ...
                    <div class="tabel-analisa waktu">
                        <div class="title"><img src="<?php echo base_url('assets/dashboard/images/alarm.png'); ?>">ANALISIS
                            WAKTU
                        </div>
                        <table class="table">
                            <thead>
                    ...
                    <div class="collapse" id="collapseExample">
                        <?php foreach ($kategori as $kategoritopik) {
                            ...
                            <div class="tabel-analisa waktu">
                                <div class="title"><img
                                            src="<?php echo base_url('assets/dashboard/images/atom.png'); ?>"><?php echo $kategoritopik->nama_kategori; ?>
                                </div>
                                <table class="table">
                                    <thead>
                                    <tr>
            ...
            <div role="tabpanel" class="tab-pane" id="profile">
                <div class="tabel-analisa waktu">
                    <div class="title"><img src="<?php echo base_url('assets/dashboard/images/first.png'); ?>">Daftar
                        Ranking
                    </div>
                    <table class="table">
                        <thead>
            ...
            <div role="tabpanel" class="tab-pane" id="rekap" style="height: 800px;">
                <div class="tabel-analisa waktu">
                    <div class="title"><img src="<?php echo base_url('assets/dashboard/images/first.png'); ?>">Rekapitulasi
                        Nilai
                    </div>
                    <table class="table">
                        <thead>
...
<div id="edit-profile" class="edit-profile-wrapper">
    <div class="edit-profile-container">
        ...
        <h4>Edit Basic Info</h4><a href="javascript:;" class="close"><span
        ...
        <form id="edit-profile-form" class="edit-profile-form">
            ...
            <div class="form-group">
                ...
                <input class="input-style form-control" type="text" id="datebirth" name="datebirth"
            ...
            <div class="form-group">
                ...
                <div class="input-style form-thanks">Thank you for submitting your booking with us, this is not a
                    confirmation for your booking, our reservation staff will contact you through your email within 24
                    hours. Please also check your SPAM or JUNK mail.
                </div>
            </div>
            <div class="form-group">
                <div class="label-style">&nbsp;</div>
                <button name="csubmit" type="submit" class="btn btn-primary">Submit</button>&nbsp;<button id="Rreset"
                                                                                                          name="rreset"
                                                                                                          type="reset"
...
<script>
    window.onload = function () {
        $(function () {
            ...
            $("#list-profil").load("listprofil/" + <?php echo $_GET['profil'];?>);
            $("#list-rekap").load("listrekap/" + <?php echo $_GET['profil'];?>);
        });
    };
</script>
</body>
