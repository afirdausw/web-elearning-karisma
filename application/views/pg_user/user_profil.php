          ...
          <div class="row">
            <div class="col-sm-3">
							<div class="profil-detail">
								<div class="picture">
									<?php 
										$foto = $data_user->foto ? $data_user->foto : 'default.png';
									?>
									<img src="<?php echo base_url('assets/uploads/foto_siswa/'.$foto);?>" width="376" height="500" alt="Foto Profil Siswa LPIH" class="img-responsive">
								</div>
							</div>
						</div>
            <div class="col-sm-9">
