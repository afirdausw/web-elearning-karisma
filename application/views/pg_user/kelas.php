...
<?php $background = (isset($kelas->gambar_kelas) ? (!empty($kelas->gambar_kelas) ? base_url() . 'image/kelas/' . $kelas->gambar_kelas : base_url() . 'assets/img/icon/no-image.jpg') : base_url() . 'assets/img/icon/no-image.jpg') ?>
<section class="banner-materi darker" style="background-image: url('<?= $background ?>')"> <!-- konten Judul -->
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-12">
                <img src="<?= (isset($kelas->gambar_kelas) ? (!empty($kelas->gambar_kelas) ? base_url() . 'image/kelas/' . $kelas->gambar_kelas : base_url() . 'assets/img/icon/no-image.jpg') : base_url() . 'assets/img/icon/no-image.jpg') ?>">
            </div>
