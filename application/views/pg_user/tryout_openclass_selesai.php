				...
				<div class="deskripsi">
				        ...
				        <div class="wrapper">
				          ...
				          <div class="buttons">
								...
								<a href="<?php echo base_url().'tryout/openclass/'.$_SESSION['id_kategori']?>" class="btn btn-latihan btn-selesai btn-block">Ulangi Open Class!</a>

								<a href="<?php echo base_url().'user/dashboard';?>" class="btn btn-latihan btn-selesai btn-block">Kembali Ke Dashboard!</a>
