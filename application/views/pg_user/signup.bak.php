      ...
      <div class="container">
        ...
        <div class="row row-login">
          <div class="form-login col-xs-11 col-sm-6 col-md-5">
            ...
            <h2 class="page-title center-title">Daftar sebagai siswa</h2>
        ...
        <div class="form-group pilih-data">
          ...
          <label for="kelas">Kelas :</label>
            ...
            <p class="hero-reg text-center">Ingin daftar menjadi orang tua? Pertama login dahulu sebagai siswa <a href="<?php echo base_url('login') ?>" class="label label-info">disini</a></p>
          </div>
        </div>
