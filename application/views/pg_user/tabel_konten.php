...
<html lang="en">
	...
	<body>
		...
		<div class="container daftar-isi konten-wrapper">
				...
				<div>
					<!-- <div class="materi-thumb"> -->
						<table class="left">
							<tr>
								<td width=20%>
									<img src="<?php echo base_url('assets/pg_user/images/custom/icon-tabel-konten.png');?>" alt="Gambar Materi" class="img-responsive" style="display:inline-block;">									
								</td>
								<td class="materi-daftar">
