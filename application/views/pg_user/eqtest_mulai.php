...
<head>
    ...
    <title>Emotional Quotient Test | Lembaga Pendidikan Islam Hidayatullah</title>
...
<body onload="JavaScript:connect(); myFunction();" class="fullpage-latihansoal">
        ...
        <div class="container">
            ...
            <form id="form_soal" method="post" action="<?php echo base_url('agcutest/penilaian_eq') ?>">
                        ...
                        <div id="item_soal_<?php echo $no; ?>" class="tab-pane fade">
                            ...
                            <div class="row equal-row item-soal">
                                ...
                                <div class="col-sm-6 equal-col jawaban">
                                    ...
                                    <input type="radio" class="pilihan_jawaban" name="pilihan_jawaban<?php echo $no; ?>"
                                           id="opt-a_<?php echo $no; ?>"
                                           value="<?php echo $no; ?>-<?php echo $item->skor_a; ?>">
                                    ...
                                    <input type="radio" class="pilihan_jawaban" name="pilihan_jawaban<?php echo $no; ?>"
                                           id="opt-b_<?php echo $no; ?>"
                                           value="<?php echo $no; ?>-<?php echo $item->skor_b; ?>">

                                    <label for="opt-b_<?php echo $no; ?>" class="label-opt">

                                        <span class="opt-id"><p>B</p></span> <span
                                                class="opt"><?php echo $item->jawab_b ? html_entity_decode($item->jawab_b) : '' ?></span>

                                    </label>


                                    <input type="radio" class="pilihan_jawaban" name="pilihan_jawaban<?php echo $no; ?>"
                                           id="opt-c_<?php echo $no; ?>"
                                           value="<?php echo $no; ?>-<?php echo $item->skor_c; ?>">

                                    <label for="opt-c_<?php echo $no; ?>" class="label-opt">

                                        <span class="opt-id"><p>C</p></span> <span
                                                class="opt"><?php echo $item->jawab_c ? html_entity_decode($item->jawab_c) : '' ?></span>

                                    </label>


                                    <input type="radio" class="pilihan_jawaban" name="pilihan_jawaban<?php echo $no; ?>"
                                           id="opt-d_<?php echo $no; ?>"
                                           value="<?php echo $no; ?>-<?php echo $item->skor_d; ?>">

                                    <label for="opt-d_<?php echo $no; ?>" class="label-opt">

                                        <span class="opt-id"><p>D</p></span> <span
                                                class="opt"><?php echo $item->jawab_d ? html_entity_decode($item->jawab_d) : '' ?></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span class="btn btn-info next_soal hidden"
                                                  id="next_soal_<?php echo $no; ?>">Selanjutnya <i
                ...
                <div class="row">
                    ...
                    <button style="display:none;" type="submit" name="submit_form_soal" id="submit_form_soal"
                            value="submit">SUBMIT
                    </button>
            ...
            <nav class="text-center">
                ...
                <ul id="toggle_soal" class="pagination custom-pagination">
                    ...
                    foreach ($data_soal as $page) { ?>
                        ...
                        <li><a data-toggle="tab" href="#item_soal_<?php echo $no; ?>"
                               id="toggle_item_soal_<?php echo $no; ?>"><?php echo $no; ?></a></li>
...
<script>
    ...
    window.onload = function () {
        ...
        setInterval(function () {
            document.getElementById("submit_form_soal").click();
        }, 1800000);
