                                    ...
                                    foreach ($kategori['daftar_kategori'] as $dk) {
                                        ...
                                        <div class="tab-pane <?php echo($i == 1 ? 'active' : '') ?>"
                                            ...
                                            <ul class="list-unstyled list-materi">
                                                <?php 
                                                if(isset($dk['analisa_topik'])){
                                                foreach ($dk['analisa_topik'] as $at) {
                                                    ?>
                                                    <li>
                                                    ...
                                                    if (count($kategori['daftar_kategori']) > 0) {
                                                        foreach ($kategori['daftar_kategori'] as $dk) {
                                                            ...
                                                            <tr>
                                                                <td><?php echo $dk['nama_kategori']; ?></td>
                                                                <td><?php echo $dk['jumlah_soal']; ?></td>
                                                                <td><?php echo (isset($dk['analisawaktu'][0]) ? $dk['analisawaktu'][0]['disediakan'] : 0); ?></td>
                                                                <td><?php echo (isset($dk['analisawaktu'][0]) ? $dk['analisawaktu'][0]['dikerjakan']: 0); ?></td>
                                                                <td><?php echo (isset($dk['analisawaktu'][0]) ? $dk['analisawaktu'][0]['rata_rata']: 0); ?></td>
