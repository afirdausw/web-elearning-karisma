...
<div class="container-fluid akun-container">
	...
	<div class="card card-user">
	  <div class="image" style="background: url(<?php echo base_url('assets/dashboard/images/bg-reason2.png')?>);background-color: #16a085;background-size: 65%;"></div>
	  <div class="content">
		<div class="author">
		<?php
		...
		<a href="javascript:void(0)">
		  <img class="avatar border-gray" src="<?php echo $data_siswa->foto ? $src."$data_siswa->foto" : $src.'default.png' ?>" alt="..."/>
