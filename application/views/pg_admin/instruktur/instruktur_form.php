					...
					<div class="col-md-12">
						<div class="card">
                          ...
                          <div class="form-group">
                              ...
                              <img src="<?= (isset($data_instruktur->$table_fields[$i]) ? (!empty($data_instruktur->$table_fields[$i]) ? base_url() . 'image/instruktur/' . $data_instruktur->$table_fields[$i] : base_url() . 'assets/img/icon/no-image.jpg') : base_url() . 'assets/img/icon/no-image.jpg') ?>" alt="Foto Instruktur <?=str_replace(' ','',$data_instruktur->nama_instruktur)?>" style="display:block;max-width: 10vw;">
                          </div>
                      <?php } ?>
										</div>
									</div>
