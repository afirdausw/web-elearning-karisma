                                            ...
                                            <div class="col-md-6">
                                                <select data-placeholder="Pilih Mata Pelajaran..." name="nama_mapel"
                                                    ...
                                                    foreach ($select_options_mapel as $item) {
                                                        ...
                                                        ?>
                                                        <option <?php echo set_select('nama_mapel', $item->id_mapel, (!isset($data->id_mapel) ? FALSE : ($data->id_mapel == $item->id_mapel ? TRUE : FALSE))); ?>
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <select data-placeholder="Pilih Materi Pokok..." id="materi_pokok"
                                                    ...
                                                    foreach ($select_options_materi_pokok as $item) { ?>
                                                        <option <?php echo set_select('materi_pokok', $item->id_materi_pokok, (!isset($data->id_materi_pokok) ? FALSE : ($data->id_materi_pokok == $item->id_materi_pokok ? TRUE : FALSE))); ?>
                                            ...
                                            <div class="form-group">
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="kategori_teks">
                                                        <!-- TEKS -->
                                                        <textarea name="konten_materi" id="konten_materi"
                                                                  class="form-control "
