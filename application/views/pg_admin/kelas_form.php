                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="file" id="" class="form-control" name="gambar_kelas" accept="image/*" <?php if($page_title != "Ubah Kelas"){echo "required='required'";} ?>>
                      </div>
                    </div>
                    <?php if($page_title == "Ubah Kelas"){?>
                    <div class="col-md-6">
                      <label for="gambar_mapel">Gambar Thumbnail Sekarang</label>
                      <img src="<?=(isset($data->gambar_kelas) ? (!empty($data->gambar_kelas) && substr($data->gambar_kelas,0,5) == 'data:' ? $data->gambar_kelas : base_url().'assets/img/no-image.jpg') : base_url().'assets/img/no-image.jpg') ?>" alt="Gambar Kelas" style="display:block;max-width: 10vw;">
                    </div>
                    <?php } ?>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Deskripsi Kelas<span class="text-danger">*</span></label>
                          <textarea class="tinymce_textarea" name="deskripsi_kelas"><?php echo set_value('deskripsi_kelas', isset($data) ? $data->deskripsi_kelas : '');?></textarea>
                      </div>
                    </div>
                  </div>
