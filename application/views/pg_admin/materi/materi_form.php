                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div id="ajax-loading" class="col-xs-1 col-md-1" style="display:none;"> 
                        <img src="<?php echo base_url('assets/pg_user/images/icon/ajax-loading.gif')?>" alt="Loading..."></img>
                      </div>
                    </div>
                  </div> 
                      ...
                      <div class="form-group">
                        <div class="tab-content">
                          ...
                          <div class="tab-pane fade" id="kategori_video">
                            ...
                            <input type="text" name="konten_video" id="video_input_box" class="form-control" placeholder="Video URL" value="<?php echo set_value('konten_video', isset($data->video_materi) ? $data->video_materi : '');?>" />
                          </div>
