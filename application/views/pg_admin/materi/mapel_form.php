                                            ...
                                            <div class="col-md-6">
                                                <select data-placeholder="Pilih Kelas..." name="kelas"
                                                    ...
                                                    foreach ($select_options as $item) { ?>
                                                        <option <?php echo set_select('kelas', $item->id_kelas, (!isset($data->id_kelas) ? FALSE : ($data->id_kelas == $item->id_kelas ? TRUE : FALSE))); ?>
                                                                value="<?php echo $item->id_kelas ?>"> <?php echo $item->alias_kelas ?> </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mata_pelajaran" class="form-control"
                                                       ...
                                                       value="<?php echo set_value('mata_pelajaran', isset($data->nama_mapel) ? $data->nama_mapel : ''); ?>"
                                                       required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="" class="form-control" name="gambar_mapel"
                                                       accept="image/*">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="deskripsi_mapel" class="form-control"
                                                          placeholder="Deskripsi Mata Pelajaran"
                                                          rows="8"><?php echo set_value('deskripsi_mapel', isset($data->deskripsi_mapel) ? $data->deskripsi_mapel : ''); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <?php //} ?>
