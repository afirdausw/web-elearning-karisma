										...
										$(function(){
											$("#kelas").change(function(){
												...
												$.ajax({
													...
													beforeSend: function() {
														NProgress.start();
														//$("#containerajax").html('<div class="text-center"><img src="<?php echo base_url().'assets/img/icon/table_loading.gif'; ?>"></div>');
													},
									...
									<div class="table-responsive">
										<table id="my_datatable" class="table table-bordered table-hover">
											...
											<tr>
												<td><?php echo $i ?></td>
												<td><?php echo $row->alias_kelas; ?></td>
												<td><?php echo $row->nama_mapel; ?></td>
												<td><?php echo $row->nama_materi_pokok; ?></td>
												<td><?php echo $row->nama_sub_materi; ?></td>
												<td><?php echo ($row->kategori == 1 ? "<span class='glyphicon glyphicon-file'></span> Teks" : ($row->kategori == 2 ? "<span class='glyphicon glyphicon-play-circle'></span> Video" : ($row->kategori == 3 ? "<span class='glyphicon glyphicon-star'></span> Soal" : '-'))); ?></td>
