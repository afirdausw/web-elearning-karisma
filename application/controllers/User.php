        ...
        <script>
            $(function () {
                $(".pilih").click(function () {
                    $("#materi").html("<img src='<?php echo base_url('assets/img/icon/gears.gif'); ?>' style='margin: 20px auto 0px; width: 200px;' />");
        ...
        <script>
            $(function () {
                $(".btn-pilihmapel").click(function () {
                    ...
                    $("#materi" + kelas).html("<img src='<?php echo base_url('assets/img/icon/gears.gif'); ?>' style='margin: 20px auto 0px; width: 200px;' />");
        ...
        <script>
            $(function () {
                $(".pilihprofil").click(function () {
                    $("#tryout").html("<img src='<?php echo base_url('assets/img/icon/gears.gif'); ?>' style='margin: 20px auto 0px; width: 200px;' />");
