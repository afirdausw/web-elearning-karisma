...
class Login extends CI_Controller {
	...
	public function index()
	{
		if($this->session->userdata('is_logged_in')){
        	redirect('pg_instruktur/dashboard');
        }
		...
		else 
		{
			...
			$this->load->view('pg_instruktur/login_page', $data);
		}
	}
	...
	public function proses_login()
	{
		...
		$result = $this->model_instruktur->do_login($username, $password);
		...
		if($result === FALSE){
			...
			$login = $this->model_instruktur->data_login($username, $password);
