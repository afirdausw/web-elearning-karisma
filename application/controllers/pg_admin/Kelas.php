...
class Kelas extends CI_Controller {
	...
	public function __construct()
  {
	...
	public function proses_tambah()
	{
        ...
        if(isset($_FILES['gambar_kelas'])){
            $errors=array();
            $allowed_ext= array('jpg','jpeg','png','gif');
            $file_name =$_FILES['gambar_kelas']['name'];
            $explo = explode('.',$file_name);
            $file_ext = strtolower(end($explo));


            $file_size=$_FILES['gambar_kelas']['size'];
            $file_tmp= $_FILES['gambar_kelas']['tmp_name'];
	...
	public function proses_ubah($id)
	{
        ...
        if($_FILES['gambar_kelas']['error'] == 0){
            $errors=array();
            $allowed_ext= array('jpg','jpeg','png','gif');
            $file_name =$_FILES['gambar_kelas']['name'];
            $explo = explode('.',$file_name);
