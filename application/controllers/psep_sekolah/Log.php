	...
	public function __construct()
  {
	...
	public function index()
	{
		...
		$data = array(
			...
			'table_data' 		=> $this->model_adm->fetch_log_siswa($jenjangnya),
			'jenjangnya'	=> $jenjangnya,
			);

		$this->load->view('psep_sekolah/log_siswa', $data);
	}
	...
	public function grafik()
	{
		...
		$this->load->view('psep_sekolah/log_grafik_detail', $data);
	}
		...
		if($aksi)
		{
			switch ($aksi) {
				case 'detail_log':
					...
					if(!$id)
					{
						redirect('psep_sekolah/log');
					}
					else 
					{
						$this->load->view('psep_sekolah/log_siswa_detail', $data);
					}
					break;
